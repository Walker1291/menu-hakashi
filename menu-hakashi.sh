...
GRAFICO_OU_MENU(){
         echo -e "
       \033[1;36m =-=-=-=-=-=-=-=\033[0m
 \033[1;36m-=-=-=-=\033[0m \033[1;33mHakashiScript:\033[0m \033[1;36m=\033[0m
 \033[1;36m=      =-=-=-=-=-=-=-=
 -
 =
 =
...
echo -e "
\033[1;36ml=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=l\033[0m
\033[1;36ml\033[0m             \033[1;33mANONIMO HAKASHI\033[0m                \033[1;36ml\033[0m
\033[1;36ml=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=l\033[0m
...
\033[1;36ml\033[0m                \033[1;31m HakashiScript V1 \033[0m                  \033[1;36ml\033[0m
\033[1;36ml\033[0m         \033[1;31m/-----------------------------\ \033[0m        \033[1;36ml\033[0m
...
\033[1;33mDigite uma das opções:\033[0m'
      ...
      #Personalizando a parte 2
         echo "PS1='\033[1;31m$NICK_DO_USUARIO@TeamHakashi:\033[0m~$ '" >> bash.bashrc
     ...
     2)
       #Opcao do menu de bugar travas
          ...
          cd;su -y;cd;cd /data/data/com.whatsapp/databases;rm -rf axolotl.db;cd;cd menu-hakashi
          echo
          echo -e "\033[1;33mAPERTE ENTER PARA PROSSEGUIR:\033[0m"
          read SEGUE
          clear
...
\033[1;31mApagar tudo do celular da pessoa. Inclusive não tenho certeza se ele apaga os dados do cartão de memória, Porém eu(Hakashi) já formatei o celular Android do meu amigo(Sem querer) Com esse app. E vale destacar que o app apagou os dados do cartão de memória dele.\033[0m
...
                    ┈┃╰━━╲▕╲╱▏╱━━━┬╨╮
                    ┈╰━━╮┊▕╱╲▏┊╭━━┴╥╯
    ...
    \033[1;31m  O QUE DESEJA APRENDER HOJE COM O HAKASHI ?\033[0m
...
\033[1;33mHakashi -\033[0m \033[1;31mOq eu quero dizer é que com o termux da para utilizar o celular em modo texto.\033[0m"
                echo;echo
                echo -e "\033[1;33mAPERTE ENTER PARA PROSSEGUIR\033[0m"
                read SEGUE;;
             2)
...
Vale destacar que é o juiz que escolhe isso. Eu não tenho certeza se isso vai acontecer pois eu não sou nenhum advogado. .\033[0m"
                echo
                echo -e "\033[1;33mAPERTE ENTER PARA PROSSEGUIR\033[0m"
                read SEGUE;;
             3)
...
\033[1;31mEu (Hakashi) dividir os principais passos em duas partes, Que são:
...
\033[1;31mLogo após ter copiado o Token... abra a aba aonde está sendo executado a script HAKASHISCRIPT e escolha a opção 9.\033[0m
...
\033[1;34mEnfim, com python da pra fazer várias coisas como criar um site e até jogo etc... então vc precisa ter em mãos algum editor de texto como por exemplo o bloco de notas, e colocar esse codigo abaixo. Depois salvar o arquivo e colocar a extensão ".py" por ex: "Hakashi.py".... O .py significa que é um arquivo em python.
...
\033[0m
       \033[1;31m EU SOU UMA INTELIGENCIA ARTIFICIAL,
        CRIADA PELO HAKASHI. EM OUTRAS PA-
        LAVRAS EU SOU UM BOT.

        CHAMADO HASHI, E DAQUI EM DIANTE
        EU SEREI O SEU PROFESSOR/INSTRUTOR.
        E HOJE EU IREI PASSAR UM EXERCÍCIO
        QUE O HAKASHI MANDOU EU PASSAR PRA
        VC.\033[0m'
                echo
                echo -e "\033[1;33mAPERTE ENTER PARA PROSSEGUIR:\033[0m"
                read SEGUE
...
\033[0m\033[1;31m
  ...
  É ATRIBUÍDO A UMA VARIÁVEL.\033[0m'
		...
		echo -e '\033[1;34m
              ...
              ╭╯　 　 ╰╮   \033[0m
\033[1;31m
      O HAKASHI MANDOU EU TE ENTREGAR
...
\033[1;34mBom, Como o Bot Hashi disse no início da aula.... Para aprender a utilizar o comando de leitura em Portugol... é necessário saber sobre variáveis e constantes.
...
\033[1;33mHakashi - Bom, É sinônimo de comando. Ou seja uma linguagem independente de ser de programação ou não, Funciona a base de comandos.... e em Portugol não é diferente.\033[0m
...
\033[0m\033[1;31m
		...
		sleep 5;clear
		echo -e "\033[1;31m
Antes de começarmos a nossa aula.... Eu gostaria de falar de como eu robô hashi nascir, Eu nascir quando o Hakashi viu que não tinha tempo pra ensinar lógica de programação para vários alunos, então ele resolveu criar uma inteligência artificial que ensinasse por ele.
...
\033[1;34mA HakashiSCript foi desenvolvida pelo Werbert em agosto de 2019, E lançada em setembro de 2019. Ele obteve ajuda de alguns parceiros do hacking mas nada de mais, já que ele que programou tudo.

Hakashi Obteve apoio da team de hacking Hacket Corporation, Cujo dono é o yuti. Inclusive ele kodou a script para essa team. \033[0m
\033[1;36m=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\033[0m
...
\033[1;34mEu (Hakashi) dividir os principais passos em duas partes, Que são:
...
\033[1;34m
Logo após ter copiado o Token... abra a aba aonde está sendo executado a script HAKASHISCRIPT e escolha a opção 9.
\033[0m
...
\033[1;32mDESENVOLVEDOR(PROGRAMADOR):\033[0m
     \033[1;34mHacker_Hakashi(Werbert♤).\033[0m
\033[1;32mAJUDANTES:\033[0m
    \033[1;34m Anonimo.\033[0m
\033[1;32mSALVES:\033[0m
     \033[1;34mMatheus, Islandio, Gabriel e Anonimo Bet4.\033[0m
\033[1;32mMADE IN:\033[0m
     \033[1;34m Brasil.\033[0m"
	 echo
	 echo -e "\033[1;33mAPERTE ENTER PARA VOLTAR AO MENU PRINCIPAL:\033[0m"
 	 read SEGUE;;
    27)
